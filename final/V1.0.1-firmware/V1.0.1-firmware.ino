...
[Update Log]
---------------------------------------
    V1.0.1 Jan/10/2018 13:02 fixed DS1302 time drafting issue, ready to ship!
    ...
    V0.5.0 Oct/20/2018 17:00 rebuild the whole software(logic level)
    V0.4.0 Oct/7/2018 23:30 added touch sensor and new perfboard design
    V0.3.0 Oct/6/2018 11:30 added menu interface with animation(left and right slide)
    V0.2.8 Oct/4/2018 18:22 reduced the sram space, ready for adding more features
    V0.2.7 Oct/3/2018 20:29 added boot-up greeting message
    V0.2.5 Oct/3/2018 20:01 added eeprom save alarm data function
...
/****
drawDisplay functions for different interfaces
****/
